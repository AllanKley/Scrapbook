...
> "Eu quero correr até o corrimão e saltar em direção à janela."

Embora ambos tenham o mesmo objetivo, a forma como a ação é executada muda completamente as circunstâncias da cena. Um salto rápido pode ser mais arriscado, porém economiza tempo durante uma perseguição. Já uma abordagem cuidadosa pode ser mais segura, mas consumir tempo precioso.
...
Algumas tarefas exigem esforço contínuo ou levam tempo para serem concluídas. Exemplos incluem: escalar uma grande muralha; negociar um tratado; manter um discurso para uma multidão. Nesses casos, o mestre pode solicitar um Teste Estendido. 
...
O **Agouro** representa todos os fatores que influenciam o resultado de um teste. Ele é determinado pela diferença entre suas **Fortunas** e **Ruínas**.

>Uma **Fortuna** representa qualquer vantagem relevante para a ação como ajuda de aliados ou circunstâncias favoráveis.

>Uma **Ruína** representa qualquer fator que dificulte a ação como falta de tempo, terreno desfavorável ou condições ruins.


## Calculando o Agouro

Primeiro, Fortunas e Ruínas se cancelam mutuamente, uma para uma. Depois disso, observe qual lado sobrou.

> **SE SOBRAREM FORTUNAS -** Role uma quantidade de **d6** igual ao número de Fortunas restantes. Escolha o **maior resultado**. Esse valor é **somado** ao teste.

> **SE SOBRAREM RUÍNAS -** Role uma quantidade de **d6** igual ao número de Ruínas restantes. Escolha o **maior resultado**. Esse valor é **subtraído** do teste.
