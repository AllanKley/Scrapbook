...
sourceNote: mecanicas/classes/iluminado.md
---
Canalizadores da luz vital, focados em suporte, restauração e proteção espiritual e física.

![classes_iluminado.webp](content/devlog/attachments/classes_iluminado.webp)
...
- **Luz que Cega:** explosão luminosa que cega aliados e inimigos em uma área.
- **Limpeza de Alma:** remoção de efeitos negativos físicos e espirituais.
- **Voo de Socorro:** criação de asas para mobilidade de resgate.
- **Extração Cromática:** você suga uma cor de uma pessoa. Habilidade de debuff de combate e social.

### Purificação Altruísta
