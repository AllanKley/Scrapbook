...
Cada etapa adiciona uma nova camada ao personagem, desde suas capacidades físicas até os vínculos que o conectam à história da campanha.

Esta página apresenta uma visão geral do processo de criação. Cada tópico possui sua própria documentação com regras detalhadas.
...
Algumas campanhas podem alterar essa ordem conforme necessário.

---

# Conceito

Antes das escolhas mecânicas, pense em quem é seu personagem.

Considere perguntas como:

- Quem ele era antes da aventura?
- O que o motiva?
- Como costuma resolver problemas?
- Como ele se relaciona com outras pessoas?
- Que papel ele deseja exercer dentro do grupo?

Um conceito sólido facilita todas as escolhas posteriores.
...
Além das vantagens mecânicas, Patronos também possuem forte importância narrativa e podem influenciar a história, objetivos e relações do personagem.
