...
Uma pausa breve — minutos, não horas — o suficiente para recuperar o fôlego, mas curta demais para as Ações de Descanso abaixo.
...
Representa horas de descanso de verdade — acampar, dormir em uma pousada, ou qualquer pausa longa o bastante para o grupo se dispersar e cada um cuidar de algo diferente. Normalmente exige um local com algum nível de segurança (montar guarda, uma sala fechada, uma pousada).
...
### Celebrar
Conte uma história, toque um instrumento, cozinhe algo melhor que ração de viagem — qualquer coisa que levante o ânimo do grupo. Faça um teste de [Performance](#/devlog/entry/pericias); em caso de sucesso, todo o grupo recebe **1 Fortuna** no primeiro teste que realizar na próxima cena.
