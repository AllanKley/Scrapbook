...
Você joga como um **Caçador**: alguém que entra nesses lugares para fechar Fraturas, recuperar Ecos e lidar com tudo que o resto do mundo prefere deixar para especialistas.

Para a história completa — a natureza da Essência, a causa (ainda em rascunho) do selamento original, como Fraturas e Cores funcionam, e as zonas sem controle — veja [lore_mundo](#/devlog/entry/lore-mundo). Para saber quais regiões do mundo concentram as maiores Fraturas e quais viraram polos estáveis de guildas, veja [Geografia Mundial](#/devlog/entry/geografia-mundial) `(adaptado do RPG anterior, ainda em revisão)`.
...
- Fraturas que são memórias de uma era que ninguém viu de verdade;
...
Se você está criando um personagem pela primeira vez, comece por [_criacao de personagem](#/devlog/entry/criacao-de-personagem).
