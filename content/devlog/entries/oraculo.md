...
![classes_oraculo.webp](content/devlog/attachments/classes_oraculo.webp)
...
Descarte sua mão atual e compre o mesmo número de cartas.

### O Mundo

Recupere uma carta já utilizada.

1. **O Mago** — No próximo teste, seus dados de Agouro aumentam um nível e Ruínas são anuladas.
2. **A Sacerdotisa** — Receba +1d6 em testes de Intuição nesta cena.
3. **A Imperatriz** — Cure um alvo completamente em alcance médio.
4. **O Imperador** — Dê uma ordem simples de uma palavra; o alvo deve obedecer se isso não causar dano a ele ou aliados.
5. **O Papa** — Remova uma condição de um alvo em alcance toque.
...
9. **O Eremita** — Receba +2d6 em furtividade nesta cena.
...
12. **O Enforcado** — Você fica vulnerável nesta cena, mas causa +1d6 de dano em seus ataques.
...
16. **A Torre** — Crie uma onda de choque em linha que empurra criaturas até 4m para trás em alcance curto.
17. **A Estrela** — Crie uma esfera de luz flutuante que ilumina alcance curto por uma cena.
18. **A Lua** — Crie uma duplicata ilusória; ataques contra você sofrem +1 Ruína nesta cena.
19. **O Sol** — Crie uma explosão de luz que cega criaturas em alcance curto por uma rodada.
20. **O Julgamento** — Cure um ferimento de um alvo em alcance toque.
...
Enquanto possuir ao menos 1 [carta do destino](#cartas-do-destino), você recebe +1 Fortuna em testes para evitar emboscadas, armadilhas e surpresa.
...
Em um combate você pode escolher um ser por rodada para fornecer +1 Fortuna ou +1 Ruína em seu próximo teste.
...
Você pode utilizar Intuição no lugar de conhecimento e pode escolher 3 perícias em que não é treinado para obter treinamento.
